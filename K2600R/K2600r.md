...
The Kurzweil if full of IDC cables. It's a little bit of the mess. Pay attention to the metallic clamp on the connectors:
...
The pin 34 is configured in **DC mode**. This mean Kurzweil use "**Disc Change**" instead of "Disc Ready".
